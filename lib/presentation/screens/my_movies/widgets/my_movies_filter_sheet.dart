...
enum MovieSortOption {
  ...
  releaseDateDesc('Vizyon Tarihi (Yeni - Eski)'),
  releaseDateAsc('Vizyon Tarihi (Eski - Yeni)'),
  runtimeDesc('Süre (Uzun - Kısa)'),
  runtimeAsc('Süre (Kısa - Uzun)');

  final String label;
  const MovieSortOption(this.label);
}

class MyMoviesFilterResult {
  final MovieSortOption sortOption;
  final Set<String> genres;
  final int? year;

  const MyMoviesFilterResult({
...
class MyMoviesFilterSheet extends StatefulWidget {
  final List<String> availableGenres;
  final List<int> availableYears;
  final MovieSortOption currentSort;
  final Set<String> currentGenres;
  final int? currentYear;

  const MyMoviesFilterSheet({
    super.key,
  ...
  @override
  State<MyMoviesFilterSheet> createState() => _MyMoviesFilterSheetState();
}

class _MyMoviesFilterSheetState extends State<MyMoviesFilterSheet> {
  late MovieSortOption _selectedSort;
  ...
  void _resetFilters() {
    setState(() {
      _selectedSort = MovieSortOption.recentlyActive;
