...
class _CommunityScreenState extends State<CommunityScreen> {
  ...
  late List<CommunityActivityItem> _activities;
  bool _isLoading = false;

  final List<CommunityActivityItem> _mockActivities = [
  ...
  Future<void> _loadActivities() async {
    ...
    try {
      final remote = await _syncEngine.fetchCommunityActivities();
      if (mounted) {
        setState(() {
          _isLoading = false;
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ElevatedButton.icon(
                            onPressed: () async {
                              final res = await PostCommentSheet.show(context);
                              if (res == true) {
                                _loadActivities();
                              }
                            },
                            ...
                            label: Text(
                              'Yorum Yaz',
                              style: AppTypography.buttonPrimary.copyWith(fontSize: 11),
                            ),
                          ),
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        icon: const Icon(Icons.refresh_rounded, color: AppColors.secondarySlate, size: 18),
